...
const faqData = [
  ...
  {
    question: "Чи допомагаєте ви з оформленням «Зеленого тарифу»?",
    answer:
      "Абсолютно. Ми беремо на себе весь бюрократичний процес: готуємо пакет документів, розробляємо однолінійну схему, погоджуємо її з місцевим РЕМ та супроводжуємо вас аж до підписання договору на продаж електроенергії.",
  },
  {
...
export default function FAQ() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Використовуємо fromTo для 100% стабільності
      gsap.fromTo(
        ".faq-header",
        { y: 40, opacity: 0 },
        {
      ...
      gsap.fromTo(
        ...
        { y: 20, opacity: 0 },
        {
          ...
          stagger: 0.1,
          ease: "power2.out",
          clearProps: "transform", // Очищаємо транформацію після кінця, щоб нічого не застрягало
        },
      );
    }, sectionRef);
